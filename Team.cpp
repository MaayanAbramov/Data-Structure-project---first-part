...
void Team::balance_to_left(){
    while(stateOfBalanceForAdd[1]<stateOfBalanceForAdd[2] && stateOfBalanceForAdd[2]>=-1){
        makePlaceInTreeByIdBigValForAdd();
    }
    while(stateOfBalanceForAdd[0]<stateOfBalanceForAdd[1] && stateOfBalanceForAdd[1]>=-1){
        makePlaceInTreeByIdMedValForAdd();
    }
}
